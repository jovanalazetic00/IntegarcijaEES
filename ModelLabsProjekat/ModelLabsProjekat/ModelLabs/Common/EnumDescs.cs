...
namespace FTN.Common
{
    public class EnumDescs
    {
        ...
        public EnumDescs()
        {
            property2enumType.Add(ModelCode.REGULATINGCONTROL_MODE, typeof(PhaseCode));
            property2enumType.Add(ModelCode.REGULATINGCONTROL_MONITOREDPHASE, typeof(RegulatingControlModelKind));
